...
::: info
Use a schema validation library like [`Zod`](https://github.com/colinhacks/zod) to verify documents are the shape your business logic expects, prior to caching in your hyper `Cache` Service.
:::
